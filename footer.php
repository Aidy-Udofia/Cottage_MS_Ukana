    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-sm-5">
          <div class="con-info">
            <h6>Contact Us</h6>
            <p>KM4, Abak Road Ikot Ekpene,<br>
             Ukana, Essien Udim L.G.A</p>
            <ul>
              <li class="mobile">
                <p>Emegerncy Line</p>
                <p>0126-2495-370</p>
              ...
              <li class="email">
                <p>cottageukana@gmail.com</p>
                <p>info@cottagehospital.com</p>              </li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="rights style-2">
    <div class="container">
      <p>© <?php echo date("Y"); ?> Cottage Hospital Management System <span style="color: white"></span></p>
    </div>
  </div>
